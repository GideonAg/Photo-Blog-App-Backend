...
public class PhotoShareHandlerTest {
    ...
    void testSuccessfulPhotoShare() throws Exception {
        ...
        try (MockedStatic<AuthorizerClaims> mockAuth = Mockito.mockStatic(AuthorizerClaims.class);
            ...
            when(mockS3Util.getImage(dummyPhoto.getImageName(), "photo123")).thenReturn("https://mocked.link/photo.jpg");
    ...
    @Test
    void testWhenPhotoIsNotNull_ButImageNameIsNull() throws Exception {
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        Map<String, String> pathParams = new HashMap<>();
        pathParams.put("photoId", "photo123");
        request.setPathParameters(pathParams);
        ...
        try (MockedStatic<AuthorizerClaims> mockAuth = Mockito.mockStatic(AuthorizerClaims.class);
            ...
            when(mockS3Util.getImage(null, "photo123")).thenThrow(new NullPointerException("Cannot invoke getImage with null imageName"));
    ...
    void testWhenRuntimeExceptionOccurs() {
        ...
        try (MockedStatic<AuthorizerClaims> mockAuth = Mockito.mockStatic(AuthorizerClaims.class);
            ...
            when(mockS3Util.getImage("mocked-image-name.jpg", "photo123")).thenThrow(new RuntimeException("Test exception"));
    ...
    void testWhenExceptionOccurs() {
        ...
        try (MockedStatic<AuthorizerClaims> mockAuth = Mockito.mockStatic(AuthorizerClaims.class);
            ...
            mockDynamo.when(() -> DynamoDBUtil.getPhotoById("user123", "photo123")).thenThrow(new Exception("Test general exception"));
